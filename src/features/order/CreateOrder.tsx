...
// https://uibakery.io/regex-library/phone-number-react-cjs
...
function CreateOrder() {
  ...
  return (
    <div className="px-4 py-6">
      <h2 className="mb-8 text-xl font-semibold text-stone-800">Ready to order? Let's go!</h2>
      ...
      <Form method="POST">
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            ...
            id="priority"
          />
          <label htmlFor="priority" className="font-medium">Want to giive your order priority?</label>
        </div>
